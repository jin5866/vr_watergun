...
namespace com.zibra.liquid.Editor.Solver
{
    ...
    public class ZibraLiquidEditor : UnityEditor.Editor
    {
        ...
        [MenuItem("GameObject/Zibra/Zibra Liquid", false, 0)]
        ...
        [MenuItem("GameObject/Zibra/Zibra Liquid Detector", false, 30)]
        ...
        [MenuItem("GameObject/Zibra/Zibra Liquid Force Field", false, 40)]
        ...
        private static void CreateZibraAnalyticCollider(MenuCommand menuCommand, AnalyticSDF.SDFType sdfType)
        {
            String name = "ZibraLiquid Analytic Collider " + (Manipulator.AllManipulators.Count + 1);
            // Create a custom game object
            var go = new GameObject(name);
        ...
        [MenuItem("GameObject/Zibra/Zibra Liquid Analytic Collider/Sphere", false, 110)]
        private static void CreateZibraAnalyticColliderSphere(MenuCommand menuCommand)
        {
            CreateZibraAnalyticCollider(menuCommand, SDFObject.SDFType.Sphere);
        }

        [MenuItem("GameObject/Zibra/Zibra Liquid Analytic Collider/Box", false, 120)]
        private static void CreateZibraAnalyticColliderBox(MenuCommand menuCommand)
        {
            CreateZibraAnalyticCollider(menuCommand, SDFObject.SDFType.Box);
        }

        [MenuItem("GameObject/Zibra/Zibra Liquid Analytic Collider/Capsule", false, 130)]
        private static void CreateZibraAnalyticColliderCapsule(MenuCommand menuCommand)
        {
            CreateZibraAnalyticCollider(menuCommand, SDFObject.SDFType.Capsule);
        }

        [MenuItem("GameObject/Zibra/Zibra Liquid Analytic Collider/Torus", false, 140)]
        private static void CreateZibraAnalyticColliderTorus(MenuCommand menuCommand)
        {
            CreateZibraAnalyticCollider(menuCommand, SDFObject.SDFType.Torus);
        }

        [MenuItem("GameObject/Zibra/Zibra Liquid Analytic Collider/Cylinder", false, 150)]
        private static void CreateZibraAnalyticColliderCylinder(MenuCommand menuCommand)
        {
            CreateZibraAnalyticCollider(menuCommand, SDFObject.SDFType.Cylinder);
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            foreach (var instance in ZibraLiquidInstances)
            {
                foreach (var manipulator in instance.GetManipulatorList())
                {
                    ...
                    else if (manipulator.GetManipulatorType() == Manipulator.ManipulatorType.ForceField)
                    {
            ...
            if (!(reachedEmitterLimit && reachedForceFieldLimit))
            {
                ...
                if (manipulatorDropdownToggle)
                {
                    ...
                    foreach (var manipulator in Manipulator.AllManipulators)
                    {
                        ...
                        if (manipulator.GetManipulatorType() == Manipulator.ManipulatorType.ForceField &&
                            reachedForceFieldLimit)
                        {
                            continue;
                        }
